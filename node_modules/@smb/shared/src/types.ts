...
// Workflow Execution State Machine (Section 4, 10)
...
// Actor Types for Audit Events (Section 4, 15)
export type ActorType = 'agent' | 'user' | 'system';

// Supported Indian Languages (Section 2)
...
// Document verification status in Knowledge Hub
export type DocumentVerificationStatus = 'verified' | 'draft' | 'expired';

// Extracted Lead Fields structure (Section 5, 11)
...
// Product Context Item (Section 11)
...
// Audit Event Interface (Section 15)
...
// Approval Record Interface (Section 12)
...
export interface WorkflowRunTrace {
  ...
  drafted_message?: { draft_text: string; confidence: number };
...
// Evaluation Test Case & Result (Section 15)
